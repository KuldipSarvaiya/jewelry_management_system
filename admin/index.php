    ...
    <aside class="bg-background border-r border-muted/40 hidden lg:block">
      <div class="flex flex-col h-full max-h-screen">
        <div class="flex items-center h-16 border-b border-muted/40 px-6">
          <a class="flex items-center gap-2 font-semibold text-yellow-500 word-nowrap" href="#" rel="ugc">
        ...
        <nav class="flex-1 overflow-auto py-4">
          <ul class="grid gap-1 px-4">
            <li class="hover:bg-white/20 rounded-md">
              <a class="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground" href="#" rel="ugc">
