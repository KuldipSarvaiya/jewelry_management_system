...
if (isset($_GET['delete_id'])) {
  ...
  $query = "DELETE FROM `jewelry` WHERE `id` = '$delete_id'";
  $deleted = mysqli_query($conn, $query) or die("Failed to delete the Jewelry, GO Back");
        ...
        <div class="grid gap-6">
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
            <div class="flex flex-row justify-between space-y-1.5 p-6">
              <h3 class="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Manage Jewelry Products</h3>
                  ...
                  <tbody class="[&amp;_tr:last-child]:border-0">
                    ...
                    ?>
                      <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                        ...
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0"><?php echo $data[3]; ?></td>
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">₹ <?php echo $data[5]; ?></td>
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0"><?php echo $data[7]; ?></td>
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0"><?php echo $data[8]; ?></td>
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                          <div class="max-w-[300px]"><?php echo $data[6]; ?></div>
                        </td>
                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                          <div class="flex items-center gap-4">
