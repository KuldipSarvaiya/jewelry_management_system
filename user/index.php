...
<body>
  ...
  <div class="flex flex-col min-h-dvh bg-background">
    <header class="px-4 lg:px-6 h-14 flex items-center">
      <a class="flex items-center justify-center text-yellow-500" href="#">
    ...
    <main class="flex-1">
      <section class="w-full pt-12 md:pt-16 lg:pt-16 border-y">
        <div class="px-4 md:px-6 space-y-10 xl:space-y-16">
          ...
          <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
            <div class="relative">
              <img src="https://th.bing.com/th/id/OIP.bFZADjbnx-mkVm142G4SKwAAAA?rs=1&pid=ImgDetMain" width="650" height="365" alt="Jewellery" class="aspect-video overflow-hidden rounded-xl object-cover" />
        ...
        <div class="container space-y-12 px-4 md:px-6 w-full m-auto">
          ...
          <div class="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3 w-full m-auto">
            <div class="grid gap-1 w-full m-auto">
              <div class="relative">
                <img src="https://th.bing.com/th/id/OIP.bFZADjbnx-mkVm142G4SKwAAAA?rs=1&pid=ImgDetMain" width="200" height="200" alt="Jewellery" class="aspect-square overflow-hidden rounded-xl object-cover" />
                <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
